...
# Exercice 2.1.1 : Manipulate Python typing

Manipulate the different types of variables with the Python Notebook : [21-variables-typing.ipynb](http://localhost:8888/notebooks/Desktop/formation-python/lessons/20-introduction-to-python-programming/notebooks/21-variables_typing.ipynb)
...
# Exercice 2.1 : Create your own function

See an example of function in the Python Notebook : [22-define-functions.ipynb](http://localhost:8888/notebooks/Desktop/formation-python/lessons/20-introduction-to-python-programming/notebooks/22-define-functions.ipynb) and create your own one.
